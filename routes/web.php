...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Package Management
    Route::resource('packages', \App\Http\Controllers\Admin\AdminPackageController::class)->names('admin.packages');
    Route::patch('packages/{package}/toggle-active', [\App\Http\Controllers\Admin\AdminPackageController::class, 'toggleActive'])
...
Route::middleware(['auth', 'role:user'])->group(function () {
    ...
    // Design Factor (DF1, DF2, etc.) - Protected by check.subscription
    Route::middleware(['check.subscription'])->group(function() {
        ...
        Route::post('/design-factors/lock-summary-df510', [\App\Http\Controllers\DesignFactorController::class, 'lockSummaryDf510'])
            ->name('design-factors.lock-summary-df510');
