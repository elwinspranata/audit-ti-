...
class CobitDataSeeder extends Seeder
{
    ...
    public function run()
    {
        // Don't truncate! We want existing data (like imported Excel questions) to persist.
        // We will just add default data if it doesn't exist.
        ...
        foreach ($data as $itemData) {
            ...
            foreach ($itemData['kategoris'] as $kategoriData) {
                // Buat atau cari Kategori yang berelasi dengan CobitItem
                ...
                foreach ($levelDataArray = $kategoriData['levels'] as $levelData) {
                    // Buat atau cari Level yang berelasi dengan Kategori
                    ...
                    foreach ($levelData['pertanyaan'] as $pertanyaan) {
                        // Buat atau cari Quisioner yang berelasi dengan Level
                        Quisioner::firstOrCreate([
