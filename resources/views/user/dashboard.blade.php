    ...
    <div class="min-h-screen py-8 bg-gray-100">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3 animate-fadeInUp animation-delay-300">
                ...
                @else
                    <a href="{{ route('pricing.index') }}" class="relative block p-6 overflow-hidden transition-all duration-300 bg-gray-100 border-2 border-dashed border-gray-300 shadow-md rounded-xl hover:shadow-xl hover:border-blue-400 group">
                        {{-- Lock overlay --}}
                        ...
                        <div class="flex items-center mb-4">
                            <div class="flex items-center justify-center w-12 h-12 bg-gray-200 rounded-lg group-hover:bg-blue-100">
                                <svg class="w-6 h-6 text-gray-400 group-hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                </svg>
                            </div>
                        </div>
                        <h3 class="text-lg font-semibold text-gray-500">Design Factors</h3>
                        <p class="mt-1 text-sm text-gray-400">Beli paket terlebih dahulu untuk mengakses fitur ini</p>
                    </a>
                @endif
