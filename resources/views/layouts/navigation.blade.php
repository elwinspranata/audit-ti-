<nav x-data="{ open: false }"
    class="relative z-30 bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700 hide-on-print">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                <x-responsive-nav-link :href="route('user.assessments.index')" :active="request()->routeIs('user.assessments.*')">
                    {{ __('My Assessments') }}
                </x-responsive-nav-link>
            @endauth
        </div>
