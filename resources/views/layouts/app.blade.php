    ...
    <head>
        ...
        <style>
            @media print {
                ...
                /* Pastikan container chart mempertahankan tingginya saat print */
                .print-chart-container {
                    width: 100% !important;
                    margin: 0 auto !important;
                    overflow: visible !important;
                    /* Tinggi di-set via inline style pada masing-masing elemen */
                    position: relative !important;
                }
                /* Canvas harus terlihat dan punya ukuran explicit */
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <footer class="border-t bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 hide-on-print">
