<x-admin-layout>
    <div class="py-12 mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Tambahkan deskripsi layanan baru untuk halaman pricing</p>
        </div>
        ...
        <form action="{{ route('admin.service-types.store') }}" method="POST" id="serviceForm">
            @csrf
            @include('admin.service-types._form', ['serviceType' => null])
        </form>
    </div>
</x-admin-layout>
