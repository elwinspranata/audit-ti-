        ...
        <div class="mb-8 flex items-center gap-4 animate-fadeInDown">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-sky-400 via-sky-300 to-cyan-400">
                    Edit Voucher: {{ $coupon->code }}
                </h2>
                <p class="text-gray-600 dark:text-gray-400">Perbarui informasi kode promo Anda</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="package_id"
                            ...
                            @foreach($packages as $package)
                                <option value="{{ $package->id }}" {{ old('package_id', $coupon->package_id) == $package->id ? 'selected' : '' }}>
                    ...
                    <div class="flex items-center gap-3">
                        <label class="relative inline-flex items-center cursor-pointer mt-6">
                            ...
                            <span class="ml-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Status Aktif</span>
                        </label>
                    </div>
                </div>
