<x-admin-layout>
    <div class="py-12 mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        <div class="mb-8 animate-fadeInDown">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Buat paket layanan baru dengan fitur-fitur yang ditentukan</p>
        </div>
        ...
        <form action="{{ route('admin.packages.store') }}" method="POST" id="packageForm">
            ...
            <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="3"
                                      class="block w-full px-4 py-3 border border-gray-200 dark:border-slate-600 rounded-xl bg-gray-50 dark:bg-slate-900 text-gray-700 dark:text-gray-200 focus:ring-sky-500 focus:border-sky-500 transition-all duration-300"
                                      placeholder="Deskripsi singkat paket (opsional)">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center space-x-8">
                            ...
                            <label class="flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_popular" value="1" {{ old('is_popular') == '1' ? 'checked' : '' }}
                ...
                <div class="bg-white/80 backdrop-blur-md dark:bg-slate-800/80 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-xl p-6 animate-fadeInUp">
                    ...
                    <div id="emptyFeaturesMessage" class="text-center py-8 text-gray-400 dark:text-gray-500">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Restore old features from validation errors
            @if(old('features'))
