        ...
        function updateDF5ResultsTable(results) {
            ...
            results.forEach(result => {
                ...
                tbody.innerHTML += `<tr>
                    ...
                    <td class="font-bold text-gray-700">${(result.score).toFixed(2)}</td>
                    <td class="font-bold text-gray-700">${(result.baseline_score).toFixed(2)}</td>
                    <td>
                        <span class="relative-importance font-black text-lg ${valClass}">${sign}${Math.round(result.relative_importance)}</span>
                    </td>
                </tr>`;
            });
        }
