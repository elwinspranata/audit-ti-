                            ...
                            <tr>
                                ...
                                <td class="p-0 border-r border-[#1e2f13] bg-val-{{ $impact }} impact-cell">
                                    <input type="number" name="inputs[{{ $index }}][impact]"
                                        ...
                                        class="heat-input impact-input df3-input"
                                        data-index="{{ $index }}" data-key="{{ $index }}" {{ $designFactor->is_locked ? 'disabled readonly' : '' }}>
                                </td>
                                ...
                                <td class="p-0 border-r border-[#1e2f13] bg-val-{{ $likelihood }} likelihood-cell">
                                    <input type="number" name="inputs[{{ $index }}][likelihood]"
                                        ...
                                        class="heat-input likelihood-input df3-input"
                                        data-index="{{ $index }}" data-key="{{ $index }}" {{ $designFactor->is_locked ? 'disabled readonly' : '' }}>
                                </td>
...
<script>
    window.factorCalculate = function(context) {
        ...
        // Fix for parsing alpha-numerical string keys properly (RS01, RS02, etc.)
        ...
        for (const k of keys) {
            ...
            const scoreTd = document.querySelectorAll('.score-display')[scoreIndex];
            if (scoreTd) {
